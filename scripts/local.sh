...
# This script provides commands to build, run, test, and manage the Spring Boot user service
...
JAR_NAME="user_service-0.0.1-SNAPSHOT.jar"
DEFAULT_PORT=8081
...
show_help() {
    echo "User Service Local Development Script"
    echo ""
