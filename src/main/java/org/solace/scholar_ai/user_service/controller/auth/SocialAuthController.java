...
public class SocialAuthController {
        ...
        @Operation(summary = "Google OAuth Login", description = """
                        ...
                        **For Swagger Testing:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Google login successful", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Google Login Success", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "ID token is missing", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Missing ID Token", value = """
                                        {
                                          "statusCode": 400,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "401", description = "Invalid Google ID token or authentication failed", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Invalid ID Token", value = """
                                        {
                                          "statusCode": 401,
        ...
        public ResponseEntity<APIResponse<AuthResponse>> loginWithGoogle(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Google OAuth ID token", content = @Content(examples = @ExampleObject(name = "Google ID Token Example", value = """
                                        {
                ...
                try {
                        ...
                        if (authResponseFromService.getRefreshToken() != null
                                ...
                                ResponseCookie refreshCookie = ResponseCookie
                                                .from("refreshToken", authResponseFromService.getRefreshToken())
                        ...
                        return ResponseEntity.ok(
                                        APIResponse.success(HttpStatus.OK.value(), "Google login successful",
                                                        authResponseFromService));
                        ...
                        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                        .body(APIResponse.error(
                                                        ...
                                                        "Google login failed: " + e.getMessage(), null));
                        ...
                        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                        .body(APIResponse.error(
                                                        HttpStatus.UNAUTHORIZED.value(),
                                                        "Invalid Google ID token: " + e.getMessage(), null));
                } catch (Exception e) {
                        logger.error("Unexpected error during Google social login: ", e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(APIResponse.error(
                                                        HttpStatus.INTERNAL_SERVER_ERROR.value(),
                                                        "Unexpected error during Google login.", null));
                }
        }

        @Operation(summary = "GitHub OAuth Login", description = """
                        ...
                        **For Swagger Testing:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "GitHub login successful", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "GitHub Login Success", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "GitHub authorization code is missing or invalid", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Missing Authorization Code", value = """
                                        {
                                          "statusCode": 400,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "401", description = "GitHub authentication failed", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "GitHub Auth Failed", value = """
                                        {
                                          "statusCode": 401,
        ...
        public ResponseEntity<APIResponse<AuthResponse>> loginWithGithub(
                ...
                try {
                        ...
                        if (code == null || code.trim().isEmpty()) {
                                return ResponseEntity.badRequest()
                                                .body(APIResponse.error(
                                                                ...
                                                                "GitHub authorization code is missing", null));
                        }
                        ...
                        return ResponseEntity.ok(
                                        APIResponse.success(HttpStatus.OK.value(), "GitHub login successful",
                                                        authResponse));
                        ...
                        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                        .body(APIResponse.error(
                                                        HttpStatus.UNAUTHORIZED.value(),
                                                        "GitHub login failed: " + e.getMessage(), null));
