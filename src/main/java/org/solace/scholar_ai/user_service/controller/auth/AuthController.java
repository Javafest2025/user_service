...
public class AuthController {
        ...
        @Operation(summary = "User Registration", description = """
                        ...
                        **For Swagger Testing:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "User registered successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Successful Registration", value = """
                                        {
                                          "statusCode": 201,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Registration failed - email might already exist or validation failed", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Registration Error", value = """
                                        {
                                          "statusCode": 400,
        ...
        public ResponseEntity<APIResponse<String>> register(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "User registration details", content = @Content(examples = @ExampleObject(name = "Registration Example", value = """
                                        {
        ...
        @Operation(summary = "User Login", description = """
                        ...
                        **Response includes:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Login successful", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Successful Login", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "401", description = "Invalid credentials", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Invalid Credentials", value = """
                                        {
                                          "statusCode": 401,
        ...
        public ResponseEntity<APIResponse<AuthResponse>> login(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Login credentials", content = @Content(examples = @ExampleObject(name = "Login Example", value = """
                                        {
                                          "email": "user@example.com",
                ...
                try {
                        ...
                        return ResponseEntity.ok(
                                        APIResponse.success(HttpStatus.OK.value(), "Login successful", authResponse));
        ...
        @Operation(summary = "Refresh Access Token", description = """
                        ...
                        **Request Body (Optional):**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Token refreshed successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Token Refreshed", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "401", description = "Invalid or missing refresh token", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Invalid Refresh Token", value = """
                                        {
                                          "statusCode": 401,
        ...
        public ResponseEntity<APIResponse<AuthResponse>> refreshToken(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Refresh token request (optional - can also use cookie)", content = @Content(examples = @ExampleObject(name = "Refresh Token Example", value = """
                                        {
                                          "refreshToken": "your-refresh-token-here"
                                        }
                ...
                try {
                        ...
                        return ResponseEntity.ok(
                                        APIResponse.success(HttpStatus.OK.value(), "Token refreshed successfully",
                                                        refreshed));
                } catch (BadCredentialsException e) {
                        ...
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(APIResponse.error(
                                                        HttpStatus.INTERNAL_SERVER_ERROR.value(),
                                                        "Refresh error: " + e.getMessage(), null));
                }
        }
        ...
        @Operation(summary = "Logout User", description = """
                        ...
                        **What happens:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Logged out successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Logout Success", value = """
                                        {
                                          "statusCode": 200,
        ...
        @Operation(summary = "Forgot Password", description = """
                        ...
                        **Note:** In production, this code will be sent via email/notification service.
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Reset code generated successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Reset Code Generated", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Email not found or invalid", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Email Not Found", value = """
                                        {
                                          "statusCode": 400,
        ...
        public ResponseEntity<APIResponse<String>> forgotPassword(
                        @Parameter(description = "Email address for password reset", example = "user@example.com") @RequestParam String email) {
                try {
        ...
        @Operation(summary = "Reset Password", description = """
                        ...
                        **Process:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Password reset successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Password Reset Success", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Invalid reset code or email", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Invalid Reset Code", value = """
                                        {
                                          "statusCode": 400,
        ...
        public ResponseEntity<APIResponse<String>> resetPassword(
                        ...
                        @Parameter(description = "New password", example = "newSecurePassword123") @RequestParam String newPassword) {
                try {
        ...
        @Operation(summary = "Confirm Email", description = """
                        ...
                        **Process:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Email confirmed successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Email Confirmation Success", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Invalid OTP code or email already confirmed", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Invalid OTP", value = """
                                        {
                                          "statusCode": 400,
        ...
        public ResponseEntity<APIResponse<String>> confirmEmail(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Email confirmation details", content = @Content(examples = @ExampleObject(name = "Email Confirmation Example", value = """
                                        {
                                          "email": "user@example.com",
                                          "otp": "123456"
                                        }
                                        """))) @Valid @RequestBody EmailConfirmationDTO emailConfirmationDTO) {
                try {
                        ...
                        return ResponseEntity.ok(APIResponse.success(
                                        HttpStatus.OK.value(), "Email confirmed successfully. Welcome email sent.",
                                        null));
                } catch (Exception e) {
                        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                        .body(APIResponse.error(HttpStatus.BAD_REQUEST.value(), e.getMessage(), null));
        ...
        @Operation(summary = "Resend Email Verification", description = """
                        ...
                        **Use case:** When the original verification email expires or user didn't receive it.
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Verification email resent successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Email Resent", value = """
                                        {
                                          "statusCode": 200,
                                        ...
                                        """))),
                        @ApiResponse(responseCode = "400", description = "Email not found or already confirmed", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Email Not Found", value = """
                                        {
                                          "statusCode": 400,
        ...
        public ResponseEntity<APIResponse<String>> resendEmailVerification(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Resend email verification request", content = @Content(examples = @ExampleObject(name = "Resend Verification Example", value = """
                                        {
                                          "email": "user@example.com"
                                        }
                                        """))) @Valid @RequestBody ResendEmailConfirmationDTO resendEmailConfirmationDTO) {
                try {
                        logger.info("resend-email-verification endpoint hit with email: {}",
                                        resendEmailConfirmationDTO.getEmail());
        ...
        @Operation(summary = "Check Email Confirmation Status", description = """
                        ...
                        **Response includes:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Email status retrieved successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Email Status", value = """
                                        {
                                          "statusCode": 200,
        ...
        public ResponseEntity<APIResponse<EmailConfirmationStatusDTO>> checkEmailStatus(
                ...
                try {
                        ...
                        return ResponseEntity.ok(
                                        APIResponse.success(HttpStatus.OK.value(),
                                                        "Email status retrieved successfully", status));
                } catch (Exception e) {
                        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                        .body(APIResponse.error(HttpStatus.BAD_REQUEST.value(), e.getMessage(), null));
                }
        ...
        @Operation(summary = "Check Email Availability", description = """
                        ...
                        **Response:**
                        ...
                        """)
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Email availability checked successfully", content = @Content(mediaType = "application/json", examples = @ExampleObject(name = "Email Available", value = """
                                        {
                                          "statusCode": 200,
        ...
        public ResponseEntity<APIResponse<EmailAvailabilityDTO>> checkEmailAvailability(
                        @Parameter(description = "Email address to check", example = "newuser@example.com") @RequestParam String email) {
                try {
                        ...
                        return ResponseEntity.ok(APIResponse.success(
                                        HttpStatus.OK.value(), "Email availability checked successfully",
                                        availability));
                } catch (Exception e) {
                        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                                        .body(APIResponse.error(HttpStatus.BAD_REQUEST.value(), e.getMessage(), null));
